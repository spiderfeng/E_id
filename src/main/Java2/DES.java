...
public class DES {
   ...
   private  static String defaultKey = "test1234";

   /* public static void main(String[] args) throws Exception {
        String data = "张三，安徽理工大学计算机科学与工程学院信息安全专业冯庆玲，341322199601045621";
    ...
    public static String getResult(String data,String key) throws Exception {
